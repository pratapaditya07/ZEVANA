    ...
    function z(t) {
        ...
        return (
            ...
            ((e = t.style[k]),
                ...
                e
                    ? (t.style[k] = e)
                    : t.style.removeProperty(k.replace(/([A-Z])/g, "-$1").toLowerCase())),
            i || m.clone()
        );
    }
    function A(t, e) {
        var i,
            ...
            p = t.parentNode,
            c =
                p && !l && p.shadowRoot && p.shadowRoot.appendChild ? p.shadowRoot : p;
        if (t === y) return t;
        if ((h.length || h.push(x(t, 1), x(t, 2), x(t, 3)), (i = l ? d : f), l))
                            ...
                            (n = (n = t.transform ? t.transform.baseVal : {}).numberOfItems
                                ? 1 < n.numberOfItems
                                    ? (function _consolidate(t) {
                                        for (var e = new F(), i = 0; i < t.numberOfItems; i++)
            ...
            if (((a = s = 0), w))
                for (
                    ...
                    4 < (y.getComputedStyle(r)[k] + "").length &&
            ...
            return (
                F || !m
                    ...
                    : ((p = (h = (function _getInverseGlobalMatrix(t) {
                        ...
                        (w =
                            Math.sqrt(Math.pow(p.c, 2) + Math.pow(p.d, 2)) * Math.cos(s * N)),
                        r &&
                        ((r = I(r)[0]),
                            (u = Q.getProperty(r)),
                ...
                F || !m
                    ...
                    : B || m !== e.parent
                        ? (d.renderTransform(1, d),
                            ...
                            (v += l.y - o.y))
                        : ((h.e = h.f = 0),
                            (g += (l = h.apply({ x: E - t.matrix.e, y: M - t.matrix.f })).x),
                            (v += l.y)),
                (g = P(g, 0.02)),
                (v = P(v, 0.02)),
                !a || a instanceof ht
                    ...
                    for (n in u)
                        (a = g[n]),
                            ...
                            s
                                ...
                                : (i ? (i.isDifferent(e) ? lh(e, i, r) : p.push(r)) : f.push(r),
                                    a && mh(a, i, a.element));
                    for (n in h)
                        u[n] || (d.push(h[n].element), v[n] && d.push(v[n].element));
                ...
                (q.update = function update(e, i) {
                    var n = this,
                        ...
                        l =
                            ...
                            r.getBBox(),
                        h = i
                            ? new F(1, 0, 0, 1, o.left + u(), o.top + t())
